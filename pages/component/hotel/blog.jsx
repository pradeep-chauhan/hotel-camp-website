          ...
          <div class="row">
            <div class="d-flex justify-content-center">
              <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <h3 class="display-5 mt-5 text-center" itemProp='name'><strong>Read our awesome blog post for everyone</strong></h3>
        ...
        <div class="container">
          <div class="row mt-5">
            <div class="col-lg-6 col-xl-6 col-md-6 col-sm-12 col-xs-12 ">
              <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" itemProp='description'>
            ...
            <div class="col-lg-6 col-xl-6 col-md-6 col-sm-12 col-xs-12 ">
              <div class="row mb-5">
                <Image src={Image1} alt="" itemprop="image"></Image>
                <h3 class="mt-3" itemProp='name'>Lorem ipsum dolor sit amet, adipisicing elit. Nisi!</h3>
                <p class="text-muted" itemProp='description'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Animi ipsa enim quo tempora
