      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 col-md-12 text-sec ms-auto">
            ...
            <p class="para">We will help you to enjoy wonderfull vacation foodie with your family</p>
            <p class="paraga">Lorem ipsu to introduce visitors and locals alike to the bes signature dishesu unique
            ...
            <p class="paraga">and "Best Date Night Spot" by Las Vegas Review-Journal, awarded "Best Food/Beverage Tour
